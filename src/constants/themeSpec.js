...
export const CELL_CSS = {
  /* 이미지 96.7 x 53.3pt (=290x160 @3x)
     · capTop 44pt  → 말풍선 몸통(30~53.3pt) 안쪽, 아래 고정 8.3pt = 바깥선
     · insets 합(top+bottom) + 글자 한 줄(17pt) 이 이미지 높이보다 커야
       셀이 '늘어남'으로만 동작한다. 작으면 이미지가 눌려서 다 찌그러진다. */
  receive01: { cap: '44px 40px', insets: '33px 32px 5px 6px' },
  send01:    { cap: '44px 6px',  insets: '33px 6px 5px 32px' },
  receive02: { cap: '12px 40px', insets: '4px 32px 4px 6px' },
  send02:    { cap: '12px 6px',  insets: '4px 6px 4px 32px' },
};
