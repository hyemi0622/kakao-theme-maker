...
export const CELL01 = {
  w: 300, h: 201,                   // @3x
  char: 144,                        // 캐릭터 정사각 박스 (48pt)
  bubble: { w: 258, h: 87 },        // 말풍선 몸통 86 x 29 pt
};
/* ── 연속 메시지: 100 x 34 pt (캐릭터 없음) ── */
export const CELL02 = {
  w: 300, h: 102,
  char: 0,
  bubble: { w: 258, h: 102 },
...
export const CELL_CSS = {
  /* insets = top left bottom right (1배수 pt)
     말풍선 안쪽 여백을 최소로 → 글자에 딱 붙게 */
  receive01: { cap: '52px 60px', insets: '45px 20px 6px 8px' },
  send01:    { cap: '52px 12px', insets: '45px 8px 6px 20px' },
  receive02: { cap: '17px 60px', insets: '7px 20px 7px 8px' },
  send02:    { cap: '17px 12px', insets: '7px 8px 7px 20px' },
};
